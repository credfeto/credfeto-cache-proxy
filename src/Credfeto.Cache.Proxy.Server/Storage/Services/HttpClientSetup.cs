...
internal static class HttpClientSetup
{
    ...
    {
        return services.AddHttpClient(nameof(ContentDownloader), configureClient: httpClient => InitializeContentClient(httpClient: httpClient, httpTimeout: HttpTimeout))
