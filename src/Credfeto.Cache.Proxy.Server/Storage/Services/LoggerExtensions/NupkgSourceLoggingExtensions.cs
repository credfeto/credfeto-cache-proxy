...
internal static partial class NupkgSourceLoggingExtensions
{
    ...
    public static partial void UpstreamPackageFailed(this ILogger<ContentSource> logger, Uri upstream, HttpStatusCode statusCode);

    [LoggerMessage(LogLevel.Information, EventId = 1, Message = "Retrieved Cached NUPKG from {upstream} Length: {length}")]
